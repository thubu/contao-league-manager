		...
		<table>
			...
			<?php foreach($this->fields as $field): ?>
				<?php
					switch($field){
						case 'special':
							?><th class="Place"><?php echo($GLOBALS['TL_LANG']['league-manager']['resulttable']['Special']); ?></th><?php
							break;
						case 'place':
							?><th class="Place"><?php echo($GLOBALS['TL_LANG']['league-manager']['resulttable']['Place']); ?></th><?php
							break;
						case 'logo':
						...
						case 'name':
							...
							break;
						case 'shortname':
							?><th class="Team"><?php echo($GLOBALS['TL_LANG']['league-manager']['resulttable']['Shortname']); ?></th><?php
							break;	
						case 'matches':
			...
			<?php foreach($this->teams as $team): ?>
				...
				<?php
					switch($field){
						...
						case 'special':
							?><td 
							<?php if($team['ascent'] >=$i): {echo "class='ascent'";}
								elseif($team['ascentrelegation'] ==$i): {echo "class='ascentrelegation'";}
								elseif($team['decent'] <=$i): {echo "class='decent'";}
								elseif($team['decentrelegation'] ==$i): {echo "class='decentrelegation'";}
								elseif($team['specialplace']+$team['ascentrelegation'] >=$i): {echo "class='specialplace'";}
								?><?php endif; ?></td><?php
							break;
						...
						case 'name':
							...
							break;
						case 'shortname':
							?><td class="teamname"><?php if($team['redirect']!=''): ?><a href="<?php echo($team['redirect']); ?>"><?php endif; ?><?php echo $team['shortname']; ?><?php if($team['redirect']!=''): ?></a><?php endif; ?></td><?php
							break;	
						case 'matches':
						...
						case 'place':
							?><td class="place"><?php echo $i; ?></td><?php
							break;
						...
						case 'pp':
							...
							break;
						case 'pm':
							?><td class="pointsminus"><?php echo abs ($team['pointsminus']); ?></td><?php
							break;
						case 'pd':
