...
<!-- 
	...
	"Team reader - Next match" is part of the Contao League Manager extension Copyright (C) 2011 by Andreas Koob
		...
		<?php if ($this->match_found==1): ?>
			...
			<div class="match">
					<span class="home<?php if($this->home_own==1): ?> own<?php endif; ?>">
							...
							<?php if ($this->show_logo==1 && $this->home_logo!=''): ?><img src="./<?php echo $this->home_logo; ?>" /><?php endif; ?>
							<span class="name"><?php echo $this->home_shortname; ?></span>
					...
					<span class="away<?php if($this->away_own==1): ?> own<?php endif; ?>">
							...
							<?php if ($this->show_logo==1 && $this->away_logo!=''): ?><img src="./<?php echo $this->away_logo; ?>" /><?php endif; ?>
							<span class="name"><?php echo $this->away_shortname; ?></span>
							<?php if($this->redirectaway!=''): ?></a><?php endif; ?></span>
			</div>
			
			<div class="place">
					<span class="location"><?php echo $this->location; ?></span>
			</div>

			<?php if($this->redirectmatch!=''): ?>
			<div class="matchinfo">
					<a href="<?php echo $this->redirectmatch; ?>"><?php echo($GLOBALS['TL_LANG']['league-manager']['matchreader_nextmatch']['matchinfos']); ?></a>
			</div><?php endif; ?>
