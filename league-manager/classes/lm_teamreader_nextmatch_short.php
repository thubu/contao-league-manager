 ...
 * @package    Controller
 */
class lm_teamreader_nextmatch_short extends ContentElement
{
	 ...
	 * @var string
	 */
	protected $strTemplate = 'lm_teamreader_nextmatch_short';
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			$return="Next match per team - shortname<br />";
	...
	protected function compile()
	{
		switch($this->lm_template){
			case "div":
				$objTemplate = new FrontendTemplate("lm_teamreader_nextmatch_short");
				break;
			case "table":
				$objTemplate = new FrontendTemplate("lm_teamreader_nextmatch_short_table");
				break;
			default:
				$objTemplate = new FrontendTemplate("lm_teamreader_nextmatch_short");
		}
